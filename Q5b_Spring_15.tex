...
\arrow \reverse \arrow \function{-3, -1.1, 0.1}{(x)/((x-1)*(x-1)*(x+1))}
\arrow \reverse \arrow \function{-0.8, 0.6, 0.1}{(x)/((x-1)*(x-1)*(x+1))}
\arrow \reverse \arrow \function{1.5, 2.5, 0.1}{(x)/((x-1)*(x-1)*(x+1))}
%\point[3pt]{(0,0)}
