...
\opengraphsfile{Exam1bbb_Spring_15}
...
\question Let $\displaystyle f(x) = \sqrt{49 - x^2}$
 and $\displaystyle g(x) = x^2 - 49$.
 \begin{parts}
...
\begin{parts}
\part[1] Is this statement true or false?  One of the inequalities which define the feasible region is $\displaystyle y\geq -x+3$. 

\begin{oneparchoices}
\choice True \choice False
\end{oneparchoices}
\part[1] Is this statement true or false?  One of the inequalities which define the feasible region is $\displaystyle y\leq 0.5x+3$. 

\begin{oneparchoices}
\choice True \choice False
\end{oneparchoices}
\part[1] Is this statement true or false? If the objective function is $\displaystyle M=200-x-y$, then  the maximum of $M$ in the feasible region cannot be at $(2,2)$.
...
\question[4] Graph a function $f$ with domain $[-2,1]$ and range $[-1,2]$.
